...
const Banner = () => {
  return (
    <div>
      <div className="grid grid-cols-2 gap-10 items-center justify-center h-[78vh] px-10">
        ...
        <div className="col-span-1 flex justify-center items-center  h-full relative">
          ...
          <Image
            ...
            height={500}
            src={
              "https://i.ibb.co.com/39cmq72S/mohammed-idris-djoudi-r-E1-G0r-Ad-Axk-unsplash.jpg"
            }
          />
